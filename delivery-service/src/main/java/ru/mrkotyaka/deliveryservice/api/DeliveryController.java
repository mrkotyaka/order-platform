...
public class DeliveryController {
    ...
    public OrderRsDto setDelivered(
        ...
        var delivery = deliveryProcessor.getDelivery(orderId);
        var deliveryUserId = delivery.getCourierId().getUserId();
        ...
        return deliveryProcessor.setStatusDelivered(delivery);
    }
}
