...
- Разные магазины для доставки. Разные цены на одни и те же позиции
- Сервис самого магазина с остатками товаров и пополнения. Отдельный запуск.
- Выручка сервиса доставки, выручка магазина
